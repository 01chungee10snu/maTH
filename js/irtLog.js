...
function createIrtAttemptRecord(input = {}) {
    ...
    return {
        ...
        learning_phase: problem.selection_policy?.phase || null,
        target_skill: problem.selection_policy?.targetSkill || null,
        selection_utility: normalizeIrtLogNumber(problem.selection_policy?.utility, null),
